...
namespace DijkstraShortestPath2
{
    class Vertex
    {
        public String name;
    ...
    class DirectedWeightedGraph
    {
        ...
        private readonly int NIL = -1;//used to initiaalise predecessors
        private readonly int INFINITY = 99999; //used to initialise path lengths of all vertices.
